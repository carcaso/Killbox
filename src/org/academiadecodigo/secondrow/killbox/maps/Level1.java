...
public class Level1 extends Map {
    ...
    public Level1() {
        ...
        getPlatforms()[0] = new Platform(new Position(1065, 260), 205, 25, "/Users/codecadet/Desktop/2D-Platform/resources/pictures" +
                "/platform1.png");
        setDoor(new Door(new Position(Var.WIDTH - Var.DOOR_WIDTH - 30,
                getPlatforms()[0].getY() - Var.DOOR_HEIGHT),getKeys().length));

        // middle platform
        getPlatforms()[1] = new Platform(new Position(475, 325), 350, 90, "/Users/codecadet/Desktop/2D-Platform/resources/pictures" +
                "/platform2.png");
